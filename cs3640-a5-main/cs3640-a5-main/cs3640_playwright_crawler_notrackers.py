...
path_to_extension = "./ghostery"
user_data_dir = "/tmp/test-user-data-dir"

#Creates and runs a persistent context with the ghostery extension for our crawler.
...
def main():
    ...
    result_filename = "playwright_crawler_notrackers_results_2.csv"
